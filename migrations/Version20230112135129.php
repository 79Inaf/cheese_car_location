 ...
 */
final class Version20230112135129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE vehicle (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, nombre_places INT DEFAULT NULL, annee INT DEFAULT NULL, boite_vitesse VARCHAR(255) DEFAULT NULL, energie VARCHAR(255) DEFAULT NULL, marque VARCHAR(255) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, kilometrage INT DEFAULT NULL, INDEX IDX_1B80E4867E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
